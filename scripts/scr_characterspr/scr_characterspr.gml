function scr_characterspr()
{
	...
	if (character == "V")
	{
		...
		spr_superjumpprep = spr_playerV_crouch;
		spr_superjump = spr_playerV_superjump;
		spr_superjumppreplight = spr_playerV_crouch;
		spr_superjumpright = spr_playerV_crouchmove;
		spr_superjumpleft = spr_playerV_crouchmove;
