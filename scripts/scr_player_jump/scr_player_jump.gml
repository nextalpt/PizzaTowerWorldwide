function state_player_jump()
{
    ...
    if (character != "V" && input_buffer_slap > 0 && (!key_up) && sprite_index != spr_suplexbump && shotgunAnim == 0 && (!global.pistol))
    {
        input_buffer_slap = 0
    ...
    else if (character != "V" && input_buffer_slap > 0 && key_up && shotgunAnim == 0 && (!global.pistol))
    {
        input_buffer_slap = 0
        state = states.punch
        image_index = 0
