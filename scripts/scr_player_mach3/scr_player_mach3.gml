	...
	switch (character)
	{
		...
		case "V":
            ...
            if (sprite_index == spr_mach4 || sprite_index == spr_fightball)
                ...
                image_speed = 0.4
            if ((!key_attack) && fightball == 0 && (!launched) && sprite_index != spr_dashpadmach && grounded && vsp > 0 && character == "V")
            {
                sprite_index = spr_machslidestart
                fmod_event_one_shot_3d("event:/sfx/pep/break", x, y)
                state = states.machslide
            ...
            if (move == (-xscale) && grounded && vsp > 0 && (!launched) && character == "V" && fightball == 0 && sprite_index != spr_dashpadmach)
            {
                fmod_event_one_shot_3d("event:/sfx/pep/machslideboost", x, y)
                sprite_index = spr_mach3boost
                state = states.machslide
            ...
            if (key_slap2 && character == "V")
            {
                ...
                image_index = 0
                with (instance_create((x + (xscale * 20)), (y + 20), obj_vigilanteshot))
                {
                    is_solid = 0
                    image_xscale = other.xscale
                }
		    ...
		    if (scr_check_superjump() && fightball == 0 && state == states.mach3 && character == "V" && vsp > 0 && sprite_index != spr_dashpadmach && (!(place_meeting(x, y, obj_dashpad))))
		    {
