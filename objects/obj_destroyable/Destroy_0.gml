...
if (ds_list_find_index(global.saveroom, id) == -1) and global.blockstyle = 1
{
	repeat (2)
	{
...
if (ds_list_find_index(global.saveroom, id) == -1) and global.blockstyle = 0
{
	repeat (2)
	{
		with (create_debris(x + random_range(0, sprite_width), y + random_range(0, sprite_height), spr_debris, true))
		{
			hsp = random_range(-5, 5);
			vsp = random_range(-10, 10);
			image_speed = 0.35;
